...
<html lang="en">
  ...
  <div class="nav" style="background-color: #e74c3c">
    <h1 class="text-center" style="color:#ecf0f1">Insert New Project</h1></div>
	<div class="container">

    <form class="well form-horizontal" action="project_insert1.php" method="post" >
<fieldset>
...
<div class="form-group">
  ...
  <input  name="project_name" placeholder="" class="form-control"  type="text">
    </div>
  </div>
</div>
...
<div class="form-group">
  <label class="col-md-4 control-label" >Project Number</label> 
    ...
    <div class="input-group">
  <span class="input-group-addon"><i class="glyphicon glyphicon-font"></i></span>
  <input name="project_number" placeholder="" class="form-control"  type="text">
    </div>
  </div>
</div>
...
<!-- Text input-->
       <div class="form-group">
  <label class="col-md-4 control-label">Controling Department</label>  
    <div class="col-md-4 inputGroupContainer">
    <div class="input-group">
        <span class="input-group-addon"><i class="glyphicon glyphicon-list-alt"></i></span>
  <input name="department_control_id" placeholder="" class="form-control"  type="text">
    </div>
  </div>
</div>
...
$sql = "insert into project(project_name, location, project_Number, dept_control_id) values('$_POST[project_name]','$_POST[location]','$_POST[project_number]','$_POST[department_control_id]')";
...
$con = mysql_connect("mysql.1freehosting.com","u938439341_user","123123");
    ...
    header('location:project_show1.php');
