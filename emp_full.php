...
$result=mysql_query("$query = 'SELECT employee.employee_id,employee.first_name, employee.last_name,EMPLOYEE.middle_name,employee.address,employee.gender,employee.date_of_birth, department.dept_id, jobs.jobs_id  
from employee inner join department on employee.dept_id = department.dept_id 
inner join jobs on employee.j_id=jobs.jobs_id';");
